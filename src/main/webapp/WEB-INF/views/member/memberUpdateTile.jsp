...
<div class="row">
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<form id="frm" class="form-horizontal" role="form" method="POST"
			action="/member/memberUpdate" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="filename"
						name="filename" placeholder="사용자 파일이름" readonly
						value="${memberVo.filename }">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="realFilename"
						name="realFilename" placeholder="사용자 파일이름" readonly
						value="${memberVo.realFilename }">
				</div>
			</div>
